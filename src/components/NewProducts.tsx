...
const NewProducts = () => {
    ...
    return (
        <div>
            <div className='text-center md:text-start mb-5 font-bold text-lg tracking-widest'>New Products</div>
            ...
            {isSuccess && data?.products.length === 0 && <NotFoundCollection message='New Arrivals Not Found' />}
